...
{
	public class AlignBottomCommand : BaseIconCommand
	{
		public override void Run()
		{
			...
			if (c != null)
			{
				...
				var str = $"barcode,Screen:{s.Bounds.Width}, ViewPort(W*H):{c.Width}*{c.Height}, TableLayout(W*H):{table.Width}*{table.Height}," +
					$" mainPanel(W*H):{panel.Width}*{panel.Height}, AutoScrollMinSize(W):{panel.AutoScrollMinSize.Width}," +
					$" vRuler(W*H):{vRuler.Width}*{vRuler.Height}";
